          ...
          <div>
            ...
            <div class="mt-10 border-t border-gray-200 pt-10">
              <fieldset>
                ...
                <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                  <label
                    class="relative flex cursor-pointer rounded-lg border border-transparent bg-white p-4 shadow-sm ring-2 ring-emerald-500 focus:outline-none"
                  >
                    <input
                      type="radio"
                      ...
                      aria-describedby="delivery-method-0-description-0
                    ...
                    <span
                      class="pointer-events-none absolute -inset-px rounded-lg border border-emerald-500"
                      aria-hidden="true"
                    ></span>
                  </label>
                  <label
                    class="relative flex cursor-pointer rounded-lg border border-gray-300 bg-white p-4 shadow-sm focus:outline-none"
                  >
                    <input
                      type="radio"
                      name="delivery-method"
                      ...
                      aria-describedby="delivery-method-1-description-0
                    delivery-method-1-description-1"
                    />
                    <span class="flex flex-1">
                      <span class="flex flex-col">
                        <span
                    ...
                    <svg
                      class="hidden h-5 w-5 text-indigo-600"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      aria-hidden="true"
                    >
